...
| |各层的激活值|各层的反向传播梯度|
|---|---|---|
| 随机初始化 |![](https://aiedugithub4a2.blob.core.windows.net/a2-images\Images\15\forward_activation1.png)激活值分布渐渐集中|![](https://aiedugithub4a2.blob.core.windows.net/a2-images\Images\15\backward_activation1.png)反向传播力度逐层衰退|
| Xavier初始化 |![](https://aiedugithub4a2.blob.core.windows.net/a2-images\Images\15\forward_activation2.png)激活值分布均匀|![](https://aiedugithub4a2.blob.core.windows.net/a2-images\Images\15\backward_activation2.png)反向传播力度保持不变|
