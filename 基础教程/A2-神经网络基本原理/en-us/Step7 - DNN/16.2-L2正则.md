...
![](https://aiedugithub4a2.blob.core.windows.net/a2-images/Images/16/norm.png)
...
![](https://aiedugithub4a2.blob.core.windows.net/a2-images/Images/16/regular2.png)
...
![](https://aiedugithub4a2.blob.core.windows.net/a2-images/Images/16/L2_sin_loss.png)

图16-14 训练过程中损失函数值和准确率的变化曲线

![](https://aiedugithub4a2.blob.core.windows.net/a2-images/Images/16/L2_sin_result.png)
